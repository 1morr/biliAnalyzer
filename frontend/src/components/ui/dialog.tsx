    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "border border-rule border-t-2 border-t-rule-strong bg-paper p-5 text-ui text-ink shadow-sheet outline-none sm:max-w-md",
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 mt-1 flex flex-col-reverse gap-2 border-t border-rule bg-paper-2 px-5 py-3.5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogDescription({ className, ...props }: DialogPrimitive.Description.Props) {
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-note leading-relaxed text-ink-2", className)}
      {...props}
    />
  )
}
