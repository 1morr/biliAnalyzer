...
Bilibili 的創作中心只給你看自己帳號的總數和幾條趨勢線，而留言與彈幕在整個網站上從來沒有被統計過，只能一支影片一支影片地讀。BiliAnalyzer 回答的是那些頁面回答不了的問題：一位創作者過去幾個月實際上是什麼樣子、觀眾對哪些詞和主題有反應、語氣有沒有在變、每一群觀眾各自怎麼表現。它吃任何公開的 UID，所以創作者回顧自己、粉絲或分析者研究別人、或是拿兩位創作者互相比較，都用得上。
